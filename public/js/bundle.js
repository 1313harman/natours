      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Loged in succesfully');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " Update succesfully"));
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripePromise = (0, _stripeJs.loadStripe)('pk_test_51QrZRMCXYGjdbEFWWwA9sFpoSOvYLvX8l76lFED6FoMOC2kTQoAUWNERwcxNCXQTRHoJPwEjf7o4oJABDUWTW7LE00sFr5rZd3');
...
var logOuBtn = document.querySelector('.nav__el--logout');
...
if (logOuBtn) {
  logOuBtn.addEventListener('click', _login.logout);
}
